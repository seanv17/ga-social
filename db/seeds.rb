...
user_6 = User.create(first_name: 'Verity', last_name: 'Heathbar', email: 'borja@gmail.com', current_city: 'San Francisco', avatar: 'https://vignette2.wikia.nocookie.net/simpsons/images/7/71/VerityHeathbar.png/revision/latest?cb=20120725224630', password: "123456", current_employer: "General Assembly", current_position: "Instructor", seeking_work: false, tech_preference: "JavaScript")
