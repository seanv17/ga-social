...
user_1 = User.create(first_name: 'Sean', last_name: 'Van Houten', email: 'seanv@gmail.com', current_city: 'Oakland', avatar: 'http://wisemansay.co.uk/wp-content/uploads/2010/09/Celebrity-Image-Simpsons-Bart-Simpson-72600.jpg', password: "123456", current_employer: "google", seeking_work: true, tech_preference: "javascript")
user_2 = User.create(first_name: 'Neil', last_name: 'Patrick', email: 'neil@gmail.com', current_city: 'San Francisco', avatar: 'http://images6.fanpop.com/image/photos/33100000/simosons-the-simpsons-33176742-250-250.jpg', password: "123456", current_employer: "facebook", seeking_work: false, tech_preference: "ruby")
user_3 = User.create(first_name: 'Sarah', last_name: 'McInrow', email: 'donm@gmail.com', current_city: 'San Francisco', avatar: 'http://www.simpsoncrazy.com/content/characters/marge.gif', password: "123456", current_employer: "instagram", seeking_work: true, tech_preference: "php")
user_4 = User.create(first_name: 'Sharon', last_name: 'Williams', email: 'kansas@gmail.com', current_city: 'Milbrae', avatar: 'http://www.polyvore.com/cgi/img-thing?.out=jpg&size=l&tid=17986400', password: "123456", current_employer: "linkedin", seeking_work: false, tech_preference: "python")
user_5 = User.create(first_name: 'Remy', last_name: 'Gleason', email: 'remy@gmail.com', current_city: 'San Jose', avatar: 'http://www.simpsoncrazy.com/content/characters/cbg.gif', password: "123456", current_employer: "oracle", seeking_work: true, tech_preference: "javascript")
user_6 = User.create(first_name: 'Sebastian', last_name: 'Ringwald', email: 'sebas@gmail.com', current_city: 'Pleasanton', avatar: 'http://www.simpsoncrazy.com/content/characters/abe.gif', password: "123456", current_employer: "general assembly", seeking_work: true, tech_preference: "binary")
