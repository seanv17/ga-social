...
user_1 = User.create(first_name: 'Frank', last_name: 'Neurath', email: 'seanvanho@gmail.com', current_city: 'Oakland', image: 'https://lh3.googleusercontent.com/-KX3oTGDrpxI/AAAAAAAAAAI/AAAAAAAAAAA/jWI9FnFdb8c/photo.jpg', password: "123456", current_employer: "Google", current_position: "Front End Developer", seeking_work: true, tech_preference: "JavaScript")
user_2 = User.create(first_name: 'Alden', last_name: 'King', email: 'alden@gmail.com', current_city: 'San Francisco', image: 'https://lh3.googleusercontent.com/-6bfWHCGuyvs/AAAAAAAAAAI/AAAAAAAB3SU/URejV2OZpJw/photo.jpg', password: "123456", current_employer: "Facebook", current_position: "Full Stack Engineer", seeking_work: false, tech_preference: "Ruby")
user_3 = User.create(first_name: 'Ged', last_name: 'Mirski-Fitton', email: 'ged@gmail.com', current_city: 'San Jose', image: 'https://lh3.googleusercontent.com/-DqUUJj792yU/AAAAAAAAAAI/AAAAAAAAAAA/e6ZLaeFkXyY/photo.jpg', password: "123456", current_employer: "Instagram", current_position: "Lead Developer", seeking_work: false, tech_preference: "PHP")
user_4 = User.create(first_name: 'Kianne', last_name: 'Anderson', email: 'kianne@gmail.com', current_city: 'Palo Alto', image: 'https://pbs.twimg.com/profile_images/475576466722152448/FVo7H-ju.png', password: "123456", current_employer: "Linkedin", current_position: "Front End Developer", seeking_work: false, tech_preference: "Python")
user_5 = User.create(first_name: 'Rob', last_name: 'Kniaz', email: 'rob@gmail.com', current_city: 'Mountain View', image: 'https://pbs.twimg.com/profile_images/445984497335427072/G83BMQUG_400x400.jpeg', password: "123456", current_employer: "Oracle", current_position: "Full Stack Develoer", seeking_work: true, tech_preference: "JavaScript")
user_6 = User.create(first_name: 'Verity', last_name: 'Heathbar', email: 'borja@gmail.com', current_city: 'San Francisco', image: 'https://vignette2.wikia.nocookie.net/simpsons/images/7/71/VerityHeathbar.png/revision/latest?cb=20120725224630', password: "123456", current_employer: "General Assembly", current_position: "Instructor", seeking_work: false, tech_preference: "JavaScript")
